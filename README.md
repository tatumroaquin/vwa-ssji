...
The repository contains two web applications [*what-is-the-year*](./simple/) and [*the-cutlery-shop*](./complex/), both showcase the same vulnerability. Written instructions on how to run each app are contained within their respective folders.
